---
name: large_feature
description: Use this skill to plan and implement large, architectural, security-sensitive, multi-module, or integration-heavy features.
---
# Skill: large_feature
...
After planning or implementation, create a .txt file with the same name as the feature in docs/.
